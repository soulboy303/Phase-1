...
public class PasswordEvaluator {
	...
	public static int foundNumsAndSpecials = 0;
	...
	public static String evaluatePassword(String input) {
		...
		foundNumsAndSpecials = 0;			// Reset the Boolean flag
		...
		while (running) {
			...
			if (currentChar >= 'A' && currentChar <= 'Z') {
				...
				foundNumsAndSpecials++;
				System.out.println(foundNumsAndSpecials);
		...
		if (foundNumsAndSpecials < 3)
			errMessage += "Numbers and Special characters; ";
